defmodule VsmPhoenix.BulletproofApplication do
  ...
  def start(_type, _args) do
    ...
    mcp_children =
      unless Application.get_env(:vsm_phoenix, :disable_mcp_servers, false) do
        [
    ...
    service_bus_children =
      if System.get_env("AZURE_SERVICE_BUS_NAMESPACE") do
    ...
    Task.start(fn ->
      ...
      if VsmPhoenix.MCP.MCPSupervisor.healthy?() do
        ...
        if function_exported?(
             VsmPhoenix.MCP.BulletproofMaggIntegrationManager,
             :magg_available?,
             0
           ) do
